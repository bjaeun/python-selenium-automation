...
COLOR_OPTIONS = (By.CSS_SELECTOR, "[class*='StyledBaseButtonInternal'] img")
SELECTED_COLOR = (By.CSS_SELECTOR, "[class*='styles__StyledVariationSelectorImag'] [class*='CellVariationHeaderWrapper']")
